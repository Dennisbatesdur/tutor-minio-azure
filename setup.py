...
about = {}
with io.open(
    os.path.join(here, "tutorminio-azure", "__about__.py"), "rt", encoding="utf-8"
) as f:
    exec(f.read(), about)
...
setup(
    ...
    project_urls={
        ...
        "Code": "https://github.com/Dennisbatesdur/tutor-minio-azure",
        "Issue tracker": "https://github.com/Dennisbatesdurh/tutor-minio-azure/issues",
